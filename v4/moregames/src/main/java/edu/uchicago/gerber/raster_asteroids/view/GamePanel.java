...
//    private static BufferedImage trickyStars;
    ...
    public GamePanel(Dimension dim) {
        ...
        listShip.add(new Point(0,3));
        listShip.add(new Point(0,5));
        listShip.add(new Point(4,10));
    ...
    private void drawScore(Graphics g) {
        ...
        g.drawString("arrow keys to navigate" , fontWidth, fontHeight + 40);
        g.drawString("space bar to fire" , fontWidth, fontHeight + 60);
        g.drawString("'B' to Bomb" , fontWidth, fontHeight + 80);
    ...
    public void update(Graphics g) {
        ...
        //set background
        grpOff.drawImage(bg,-300,-300,this);
...
//        grpOff.fillRect(0, 0, Game.DIM.width, Game.DIM.height);
    ...
    private void initView() {
        bg = loadGraphic("/asteroids/imgs/brick/galaxy.jpg");
//        trickyStars = loadGraphic("/asteroids/imgs/brick/trick.png");
